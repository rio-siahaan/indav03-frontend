  ...
  const questions = [
    {
      ...
      text: "Ekspor data Indeks Ketahanan Gender Kabupaten Flores Timur tahun 2021 sampai 2023.",
      color: "bg-green-50 border-green-100 hover:border-green-300",
    },
    {
      icon: <Search className="w-5 h-5 text-blue-600" />,
      text: "Berapa jumlah penduduk di Kabupaten Flores Timur tahun 2025?",
      color: "bg-blue-50 border-blue-100 hover:border-blue-300",
    },
    {
      icon: <Sparkles className="w-5 h-5 text-purple-600" />,
      text: "Siapa kepala dan alamat dari BPS Kabupaten Flores Timur?",
